...
void NormalMapApp::BuildRootSignature()
{
	...
	texTable.Init(D3D12_DESCRIPTOR_RANGE_TYPE_SRV, 10, 1, 0);
...
void NormalMapApp::MakeOpaqueDesc(D3D12_GRAPHICS_PIPELINE_STATE_DESC* inoutDesc)
{
...
void NormalMapApp::MakeSkyDesc(D3D12_GRAPHICS_PIPELINE_STATE_DESC* inoutDesc)
{
