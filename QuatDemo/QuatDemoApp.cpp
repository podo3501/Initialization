...
void QuatDemoApp::BuildDescriptorHeaps()
{
...
void QuatDemoApp::BuildShadersAndInputLayout()
{
...
void QuatDemoApp::BuildShapeGeometry()
{
...
void QuatDemoApp::BuildSkullGeometry()
{
...
void QuatDemoApp::BuildMaterials()
{
...
void QuatDemoApp::BuildFrameResources()
{
...
void QuatDemoApp::MakeOpaqueDesc(D3D12_GRAPHICS_PIPELINE_STATE_DESC* inoutDesc)
{
...
void QuatDemoApp::OnKeyboardInput(const GameTimer& gt)
{
...
void QuatDemoApp::AnimateMaterials(const GameTimer& gt)
{
}
...
void QuatDemoApp::UpdateObjectCBs(const GameTimer& gt)
{
...
void QuatDemoApp::UpdateMaterialBuffer(const GameTimer& gt)
{
...
void QuatDemoApp::UpdateMainPassCB(const GameTimer& gt)
{
...
void QuatDemoApp::Update(const GameTimer& gt)
{
	OnKeyboardInput(gt);
...
void QuatDemoApp::DrawRenderItems(
...
void QuatDemoApp::Draw(const GameTimer& gt)
{
...
void QuatDemoApp::OnMouseDown(WPARAM btnState, int x, int y)
{
...
void QuatDemoApp::OnMouseUp(WPARAM btnState, int x, int y)
{
	ReleaseCapture();
}
void QuatDemoApp::OnMouseMove(WPARAM btnState, int x, int y)
{
	if ((btnState & MK_LBUTTON) != 0)
	{
