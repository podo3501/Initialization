...
void ShapesApp::BuildRootSignature()
{
	...
	CD3DX12_ROOT_SIGNATURE_DESC rootSicDesc(3, slotRootParameter, 0, nullptr,
	...
	const std::vector<RenderItem*>& ritems)
{
	...
	for( auto ri : ritems )
	{
		...
		DirectX::XMFLOAT4X4 curWorld;
		XMStoreFloat4x4(&curWorld, XMMatrixTranspose(world));
		cmdList->SetGraphicsRoot32BitConstants(2, 16, &curWorld, 0);
